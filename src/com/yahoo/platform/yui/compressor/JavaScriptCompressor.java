...
public class JavaScriptCompressor {
	...
	static {
		...
		//literals.put(Token.KEEPCOMMENT, "/*!");
	...
	private ArrayList<JavaScriptToken> parse(Reader in,
	...
	private static void processStringLiterals(
			ArrayList<JavaScriptToken> tokens, boolean merge) {
	 ...
	 * identifier name.
	 */
	private final Pattern SIMPLE_IDENTIFIER_NAME_PATTERN = Pattern
	 ...
	 */
	private void optimizeObjectMemberAccess(
			ArrayList<JavaScriptToken> tokens) {
	 ...
	 */
	private void optimizeObjLitMemberDecl(
			ArrayList<JavaScriptToken> tokens) {
